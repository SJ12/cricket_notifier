...
ICON_PREFIX= "/media/sijo/438cef9e-c52f-4bb2-b427-2587e8b00b3b/home/sijo/Downloads/cricket-score-applet-master/icons/dark/cricscore_indicator-"
ICON_SUFFIX = ".png"
...
class CricInd:
    ...
    def create_match_item(self, match_info):
        ...
        print ICON_PREFIX + match_info['last_ball'] + ICON_SUFFIX
        match_item['gtk_menu'].set_image(Gtk.Image.new_from_icon_name('audio-card', Gtk.IconSize.BUTTON))
    ...
    def update_submenu_data(self, match_item):
        ...
        if match_item['gtk_check'].get_active():
            ...
            print 'last_ball',match_item['gtk_commentary'].get_label()
    ...
    def set_indicator_icon(self, icon):
        print ICON_PREFIX + icon+ ICON_SUFFIX
    ...
    def update_menu_icon(self, match_item):
        ...
        match_item['gtk_menu'].set_image(Gtk.Image.new_from_icon_name('cricscore_indicator-' + match_item['last_ball'] + "", Gtk.IconSize.BUTTON))
